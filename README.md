  ...
  function() {
    ...
    cprequire(
      ...
      function(myWorkspaceSparkysGrbl) {
        ...
        console.log("Workspace / grbl just got loaded.", myWorkspaceSparkysGrbl);
